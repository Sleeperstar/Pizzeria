...
if(isset($_POST['update'])){
   ...
   $update_product->execute([$name, $category, $price, $descrip, $pid]);
...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="Ingresa la descripcion" name="descrip" maxlength="200" class="box" value="<?= $fetch_products['descrip']; ?>">
      ...
      <div class="flex-btn">
         ...
         <a href="products.php" class="option-btn">Retroceder</a>
      </div>
   </form>
   <?php
         }
