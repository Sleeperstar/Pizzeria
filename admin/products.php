...
if(isset($_POST['add_product'])){
   ...
   if($select_products->rowCount() > 0){
      ...
      if($image_size > 2000000){
         ...
         $insert_product = $conn->prepare("INSERT INTO `products`(name, category, price, descrip, image) VALUES(?,?,?,?,?)");
         $insert_product->execute([$name, $category, $price, $descrip, $image ]);
...
<section class="add-products">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <input type="text" required placeholder="Ingrese la descripción" name="descrip" maxlength="200" class="box">
      ...
      <input type="submit" value="Añadir" name="add_product" class="btn">
   </form>
