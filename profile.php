...
<section class="user-details">
   ...
   <div class="user">
      ...
      <p class="address"><i class="fas fa-map-marker-alt"></i><span><?php if($fetch_profile['address'] == ''){echo 'Porfavor ingrese su dirección';}else{echo $fetch_profile['address'];} ?></span></p>
