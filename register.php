...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="password" name="pass" required placeholder="Ingrese una contraseña" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
      ...
      <p>Ya tiene una cuenta? <a href="login.php">Iniciar sesion</a></p>
   </form>
